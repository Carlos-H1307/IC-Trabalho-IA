...
def main():
    ...
    if args.quick:
        ...
        # 2 exps × 20 gens × 2 = 80 avaliações novas + 2 × 30 pop_size iniciais
        args.experiments = 2
        args.generations = 20
        args.population = 30
